...
class UpdateDriverComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            idCard: this.props.match.params.idCard,
            name: '',
            license: '',
            type: '',
            address: '',
    ...
    componentDidMount() {
        DriverService.getDriverByIdCard(this.state.idCard).then((res) => {
            let driver = res.data;
            this.setState({
    ...
    updateDriver = (e) => {
        ...
        return DriverService.updateDriver(this.state.idCard, driver)
            .then(resp => {
                            ...
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        <label>Số CMND: </label>
                                        <input disabled placeholder="Nhập số CMND" name="idCard" className="form-control"
                                    ...
                                    <button className="btn btn-success" onClick={this.updateDriver}>Cập nhật
                                    </button>
