...
class UpdateRouteComponent extends Component {
    ...
    updateRoute = (e) => {
        ...
        return RouteService.updateRoute(this.state.id, route)
            .then(resp => {
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="card col-md-6 offset-md-3">
                            <h3 className="text-center">Cập nhật thông tin tuyến đường</h3>
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.updateRoute}>Cập nhật
                                    </button>
